...
/**
 * Admin gate: email + password (the highest privilege gets the strongest
 * secret — no 6-digit PIN here). The admin account is seeded server-side
 * (scripts/seed_admin.py); there is deliberately no admin signup. Full-width
 * webpage idiom. UX gate only; the API verifies the JWT + role server-side.
 */
