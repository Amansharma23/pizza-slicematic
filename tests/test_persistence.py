...
def test_line_has_all_fields_in_order():
    ...
    assert parts[0] == "2026-06-27 12:00:00"
    assert parts[1] == "Rajan"
    assert parts[2] == "9876543210"
    assert parts[3] == "Cheese Burst"
    assert parts[6] == "677.00"      # unit_price
    assert parts[7] == "5"           # quantity
    assert parts[11] == "3594.87"    # total
    assert parts[12] == "UPI"
